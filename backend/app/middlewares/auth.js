...
// const UserAuthModel = mongoose.model('userTokenCollection');
//
...
//
// let isPlayerAuthorize = (req, res, next) => {
...
// }; // end of isAuthorize
//
// let isAdminAuthorize = (req, res, next) => {
//     console.log("isAuthorize");
//     if (req.params.authToken || req.query.authToken || req.body.authToken || req.header('authToken')) {
//         UserAuthModel.findOne({authToken: req.params.authToken || req.query.authToken || req.body.authToken || req.header('authToken')}).exec((err, authDetails) => {
//             if (err) {
//                 console.log(err);
//                 logger.error(err.message, 'AuthorizationMiddleware', 10);
//                 let apiResponse = response.generate(true, 'Failed To Authorized', 500, null);
...
//
// module.exports = {
//     isPlayerAuthorize: isPlayerAuthorize,
//     isAdminAuthorize: isAdminAuthorize
// };
